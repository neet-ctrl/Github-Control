...
import com.githubcontrol.ui.screens.auth.AppLockSetupScreen
import com.githubcontrol.ui.screens.auth.AppLockVerifyScreen
...
import com.githubcontrol.ui.screens.cache.CacheScreen
...
fun AppRoot() {
    ...
    GitHubControlTheme(settings = settings) {
        ...
        LaunchedEffect(state.loggedIn, state.locked, onboardingDone, biometricEnabled, appLockEnabled) {
            val target = when {
                !onboardingDone               -> Routes.ONBOARDING
                !state.loggedIn               -> Routes.LOGIN
                state.locked && biometricEnabled -> Routes.BIOMETRIC
                state.locked && appLockEnabled   -> Routes.APP_LOCK_VERIFY
            ...
            if (current != target && current?.substringBefore('/') != target.substringBefore('/')) {
                if (target != Routes.DASHBOARD &&
                    target !in setOf(Routes.LOGIN, Routes.BIOMETRIC, Routes.ONBOARDING, Routes.APP_LOCK_VERIFY)
                ) {
        ...
        LaunchedEffect(nav) {
            nav.currentBackStackEntryFlow.collect { entry ->
                ...
                if (route !in setOf(Routes.LOGIN, Routes.BIOMETRIC, Routes.ONBOARDING, Routes.APP_LOCK_VERIFY)) {
        ...
        NavHost(navController = nav, startDestination = startDest) {
            ...
            composable(Routes.LOGIN) {
                LoginScreen(main) {
                    ...
                    main.endAddAccount()
                    if (wasAdding && nav.previousBackStackEntry != null) nav.popBackStack()
                    else nav.navigate(Routes.DASHBOARD) { popUpTo(0) { inclusive = true } }
                }
            }
            composable(Routes.BIOMETRIC) {
                BiometricScreen(main) { nav.navigate(Routes.DASHBOARD) { popUpTo(0) { inclusive = true } } }
            }
            composable(Routes.APP_LOCK_VERIFY) {
                AppLockVerifyScreen(onVerified = {
                    nav.navigate(Routes.DASHBOARD) { popUpTo(0) { inclusive = true } }
                })
            }
            composable(Routes.APP_LOCK_SETUP) {
                AppLockSetupScreen(onBack = { nav.popBackStack() })
            }
            ...
            composable(
                ...
                RepoDetailScreen(back.arguments?.getString("owner") ?: "", back.arguments?.getString("name") ?: "", main, onBack = { nav.popBackStack() }, onNavigate = { nav.navigate(it) })
            }
            composable(
                Routes.FILES,
                arguments = listOf(
            ...
            composable(
                ...
                CommitDetailScreen(back.arguments?.getString("owner") ?: "", back.arguments?.getString("name") ?: "", back.arguments?.getString("sha") ?: "", onBack = { nav.popBackStack() })
            }
            composable(Routes.PRS, arguments = listOf(navArgument("owner") { type = NavType.StringType }, navArgument("name") { type = NavType.StringType })) { back ->
                val owner = back.arguments?.getString("owner") ?: ""
                val name  = back.arguments?.getString("name")  ?: ""
            ...
            composable(Routes.PR_DETAIL, arguments = listOf(navArgument("owner") { type = NavType.StringType }, navArgument("name") { type = NavType.StringType }, navArgument("number") { type = NavType.IntType })) { back ->
                PullDetailScreen(back.arguments?.getString("owner") ?: "", back.arguments?.getString("name") ?: "", back.arguments?.getInt("number") ?: 0, onBack = { nav.popBackStack() })
            }
            composable(Routes.CREATE_PR, arguments = listOf(navArgument("owner") { type = NavType.StringType }, navArgument("name") { type = NavType.StringType })) { back ->
                val owner = back.arguments?.getString("owner") ?: ""; val name = back.arguments?.getString("name") ?: ""
            ...
            composable(Routes.ISSUES, arguments = listOf(navArgument("owner") { type = NavType.StringType }, navArgument("name") { type = NavType.StringType })) { back ->
                val owner = back.arguments?.getString("owner") ?: ""; val name = back.arguments?.getString("name") ?: ""
            ...
            composable("create_issue/{owner}/{name}", arguments = listOf(navArgument("owner") { type = NavType.StringType }, navArgument("name") { type = NavType.StringType })) { back ->
                val owner = back.arguments?.getString("owner") ?: ""; val name = back.arguments?.getString("name") ?: ""
            ...
            composable(Routes.ISSUE_DETAIL, arguments = listOf(navArgument("owner") { type = NavType.StringType }, navArgument("name") { type = NavType.StringType }, navArgument("number") { type = NavType.IntType })) { back ->
                IssueDetailScreen(back.arguments?.getString("owner") ?: "", back.arguments?.getString("name") ?: "", back.arguments?.getInt("number") ?: 0, onBack = { nav.popBackStack() })
            }
            composable(Routes.ACTIONS, arguments = listOf(navArgument("owner") { type = NavType.StringType }, navArgument("name") { type = NavType.StringType })) { back ->
                ActionsScreen(back.arguments?.getString("owner") ?: "", back.arguments?.getString("name") ?: "", onBack = { nav.popBackStack() })
            }
            composable(Routes.SEARCH) { SearchScreen(onBack = { nav.popBackStack() }, onNavigate = { nav.navigate(it) }) }
            composable(Routes.ANALYTICS, arguments = listOf(navArgument("owner") { type = NavType.StringType }, navArgument("name") { type = NavType.StringType })) { back ->
            ...
            composable(Routes.ACCOUNTS) {
                AccountsScreen(main, onBack = { nav.popBackStack() }, onAdd = {
                    main.beginAddAccount(); nav.navigate(Routes.LOGIN)
                })
            }
            ...
            composable(Routes.CACHE)        { CacheScreen(onBack = { nav.popBackStack() }) }
            composable(Routes.APP_LOCK_SETUP) { AppLockSetupScreen(onBack = { nav.popBackStack() }) }
            composable(Routes.BRANCHES, arguments = listOf(navArgument("owner") { type = NavType.StringType }, navArgument("name") { type = NavType.StringType })) { back ->
                BranchesScreen(back.arguments?.getString("owner") ?: "", back.arguments?.getString("name") ?: "", onBack = { nav.popBackStack() })
            }
            composable(
                Routes.README,
                arguments = listOf(navArgument("owner") { type = NavType.StringType }, navArgument("name") { type = NavType.StringType }, navArgument("ref") { type = NavType.StringType; defaultValue = "" })
            ) { back ->
            ...
            composable(
                ...
                arguments = listOf(navArgument("owner") { type = NavType.StringType }, navArgument("name") { type = NavType.StringType }, navArgument("branch") { type = NavType.StringType })
            ) { back ->
            ...
            composable(
                Routes.COMPARE,
                arguments = listOf(navArgument("owner") { type = NavType.StringType }, navArgument("name") { type = NavType.StringType }, navArgument("base") { type = NavType.StringType; defaultValue = "" }, navArgument("head") { type = NavType.StringType; defaultValue = "" })
            ) { back ->
                CompareScreen(
                    owner  = back.arguments?.getString("owner") ?: "",
                    name   = back.arguments?.getString("name")  ?: "",
            ...
            composable(Routes.COLLABORATORS, arguments = listOf(navArgument("owner") { type = NavType.StringType }, navArgument("name") { type = NavType.StringType })) { back ->
                CollaboratorsScreen(back.arguments?.getString("owner") ?: "", back.arguments?.getString("name") ?: "", onBack = { nav.popBackStack() })
            }
            composable(Routes.PERMISSIONS) { com.githubcontrol.ui.screens.settings.PermissionsScreen(onBack = { nav.popBackStack() }) }
            composable(Routes.CRASHES)     { com.githubcontrol.ui.screens.settings.CrashLogScreen(onBack = { nav.popBackStack() }) }
            composable(Routes.APPEARANCE)  { com.githubcontrol.ui.screens.settings.AppearanceScreen(main = main, onBack = { nav.popBackStack() }) }
            ...
            composable(Routes.USER_PROFILE, arguments = listOf(navArgument("login") { type = NavType.StringType })) { back ->
            ...
            composable(Routes.HEALTH) {
                ...
                com.githubcontrol.ui.screens.health.HealthScreen(main = main, uploadManager = um, onBack = { nav.popBackStack() })
            }
            composable(
                Routes.RELEASES,
                arguments = listOf(navArgument("owner") { type = NavType.StringType }, navArgument("name") { type = NavType.StringType })
